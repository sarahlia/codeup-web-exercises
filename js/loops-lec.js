...
while (i >= 1) {
    console.log('Count down from 50 by 1: ' + i);
    i--;
}
...
do {
   var colorInput = prompt('Enter a color.').toLowerCase();
   console.log('colorInput: ' + colorInput);
} while (colorInput !== "blue");
...
// or Douglas' easy way, the first if line can be: if (i % 15 === 0) {
...
// Here, we are only printing even numbers.
