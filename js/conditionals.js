...
var colorConfirmation;
    ...
    switch (color) {
        case "blue":
            colorConfirmation = "Blue is the color of the sky";
            break;
        case "red":
            colorConfirmation = "Strawberries are " + color;
            break;
        default:
            colorConfirmation = "I don't know anything about " + color;
            break;
    }

console.log(colorConfirmation);
...
var input = prompt("Please type in a color.");
analyzeColor(input);
 ...
 */
    function calculateTotal(luckynumber, totalamount) {
        if (luckynumber === 0) {
            return totalamount - luckynumber;
...
alert("Your price before the discount: $ " + totalBill);

alert("Your price after the discount: $ " + (calculateTotal(luckyNumber, totalBill)));
